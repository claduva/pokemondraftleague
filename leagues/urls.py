...
urlpatterns = [ 
    ...
    path("settings/historic/", views.historic_teams_settings, name="historic_teams_settings"),
    path("settings/historic/<str:teamid>/", views.individual_historic_team_settings, name="individual_historic_teams_settings"),
    path("settings/league/<str:league_name>/", views.individual_league_settings, name="individual_league_settings"),
    path("settings/league/<str:league_name>/leagueconfiguration/", views.league_configuration_, name="league_configuration"),
    ...
    path("settings/league/<str:league_name>/managecoachs/applicants_summary/", views.applicants_summary, name="applicants_summary"),
