...
class manual_replay(models.Model):
    ...
    t1pokemon1=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team1Pokemon1')
    t1pokemon2=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team1Pokemon2')
    t1pokemon3=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team1Pokemon3')
    t1pokemon4=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team1Pokemon4')
    t1pokemon5=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team1Pokemon5')
    t1pokemon6=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team1Pokemon6')
    t2pokemon1=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team2Pokemon1')
    t2pokemon2=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team2Pokemon2')
    t2pokemon3=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team2Pokemon3')
    t2pokemon4=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team2Pokemon4')
    t2pokemon5=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team2Pokemon5')
    t2pokemon6=models.ForeignKey(roster,on_delete=models.CASCADE, related_name='Team2Pokemon6')
