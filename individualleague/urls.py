...
urlpatterns = [ 
    ...
    path("leagues/<str:league_name>/tiers/filter", views.league_tier_filter, name="league_tier_filter"),
    ...
    path("leagues/<str:league_name>/tiersbytype/", views.tiers_by_type, name="tiers_by_type"),
