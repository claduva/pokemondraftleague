...
def move_function(line,parsedlogfile,results):
    ...
    if move in increasedcrit and notimmune and targetnotprotected and targetmon and target['pokemon'] not in ['Type: Null','Slowbro-Mega','Turtonator']:
        try:
            ...
            print(e)
    elif move in movesthatcancrit and notimmune and targetnotprotected and targetmon and target['pokemon'] not in ['Type: Null','Slowbro-Mega','Turtonator']:
        try:
            if attacker['Focus Energy']:
