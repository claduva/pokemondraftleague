...
urlpatterns = [ 
    ...
    path("settings/league/<str:league_name>/<str:subleague_name>/manageseasons/", views.manage_seasons, name="manage_seasons"),
    ...
    path("settings/league/<str:league_name>/<str:subleague_name>/manageseasons/setdraftorder", views.set_draft_order, name="set_draft_order"),
